...
public class Game extends Observable {
     ...
     * 
     * @group9 help True for help on, false for help off.
     */
     ...
     *
     * @group9 selectedNumber    Number selected by user.
     */
     ...
     *
     * @group9 x     X position in game.
     * @group9 y     Y position in game.
     ...
     *
     * @group9 x         The x position in the game.
     * @group9 y         The y position in the game.
     * @group9 number    The number to be set.
     */
     ...
     *
     * @group9 game      Game to check.
     * @group9 y         Position of x axis to check.
     * @group9 number    Number to check.
     ...
     *
     * @group9 game      Game to check.
     * @group9 x         Position of y axis to check.
     * @group9 number    Number to check.
     ...
     *
     * @group9 game      Game to check.
     * @group9 x         Position of number on x axis in game to check.
     * @group9 y         Position of number on y axis in game to check.
     * @group9 number    Number to check.
     ...
     * @group9 x         X position in game.
     * @group9 y         Y position in game.
     * @group9 numbers   List of remaining numbers.
     ...
     *
     * @group9 game      Game to fill, user should pass 'new int[9][9]'.
     * @group9 index     Current index, user should pass 0.
     ...
     *
     * @group9 game      Game to be generated, user should pass a solution.
     ...
     *
     * @group9 game          Game to be generated.
     * @group9 positions     List of remaining positions to clear.
     * @return              Generated Sudoku game.
     */
     ...
     *
     * @group9 game                  Game to check.
     * @group9 index                 Current index to check.
     * @group9 numberOfSolutions     Number of found solutions. Int[] instead of
     ...
     *
     * @group9 game  Game to be printed.
     *
